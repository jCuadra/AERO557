function [ RSite ] = getRSite( siteInfo )
...
%     J = jday(siteInfo.year(i), siteInfo.month(i), siteInfo.day(i),...
%              siteInfo.hour(i), siteInfo.min(i), siteInfo.sec(i));
%     [thetaLST, ~] = lstime( siteInfo.longSite*rad, J);% + siteInfo.longmin(i)/60;
%     thetaLST = thetaLST/rad %deg
